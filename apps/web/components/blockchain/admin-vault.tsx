...
export function AdminVault() {
  ...
  const hasSucceeded =
    transaction.step === "success" && (transaction.txHash || lastTxHash);
      ...
      <Card className="border-slate-200 bg-white/90 shadow-[0_25px_80px_-48px_rgba(15,23,42,0.45)]">
        <CardHeader>
          ...
          <CardDescription className="max-w-2xl text-slate-600">
            Deposit the connected admin wallet into the vault contract through a
            Soroban transaction. The flow below shows the exact Build, Simulate,
            Sign, Submit, and Confirm states.
          </CardDescription>
        </CardHeader>
